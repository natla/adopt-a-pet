...
class TestAdoptionService(APITestCase):
    def setUp(self):
        ...
        """
        self.sharo = Pet.objects.create(species="Dog", name='Sharo', age=5, gender="M")
        ...
        self.ruh = Pet.objects.create(species="Cat", name='Ruh', age=3, gender="M")
    ...
    def test_adoption_methods(self):
        ...
        message, dog, result_list = dog_adoption_center.adopt_animal("labrador", 3, "F")

        # Assert that there is no suitable dog for adoption
